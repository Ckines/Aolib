...
VGMSTREAM* init_vgmstream_vag(STREAMFILE* sf) {
     ...
     * .khv: Kingdom Hearts (PS2), as named by common rips */
    if (!check_extensions(sf,"vag,swag,str,vig,l,r,vas,xa2,snd,svg,,wav,lwav,msv,eng,fre,ger,int,ita,jap,spa,khv"))
        return NULL;
