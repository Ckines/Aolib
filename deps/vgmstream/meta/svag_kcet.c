...
VGMSTREAM* init_vgmstream_svag_kcet(STREAMFILE* sf) {
     ...
     * at 0x400 may be header again (Silent Hill 2), more padding (Silent Scope 2),
     * or zero-filled, in which case the phrase at 0x1c is the only marker left */
    if (channel_count > 1 &&
        read_32bitBE(0x400,sf) != 0x53766167 &&     /* "Svag" */
        read_32bitBE(0x400,sf) != 0x44657369 &&     /* "Desi" */
        read_32bitBE(0x1c,sf)  != 0x44657074 &&     /* "Dept" */
        read_32bitBE(0x1c,sf)  != 0x4b43452d)       /* "KCE-" */
        goto fail;
