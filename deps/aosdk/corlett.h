...
// PARCHE LOCAL (ver deps/patches/README.md): guarda de inclusión
// añadida -- el fichero original no tenía ninguna. Inofensivo mientras
// cada "engine" de aosdk se compilaba como un .c aislado (nunca incluido
// dos veces en la misma unidad de traducción), pero nuestros wrappers de
// F3/F4 (psf_engine.hpp Y psf2_engine.hpp) incluyen corlett.h cada uno
// por su cuenta, y ambos acaban en la misma unidad de traducción
// (src/libretro.cpp) en cuanto existe más de un motor PSF. Sin guarda,
// `typedef struct {...} corlett_t;` se redefine y el compilador rechaza
// la segunda inclusión con "conflicting declaration".
#ifndef AOLIB_CORLETT_H
#define AOLIB_CORLETT_H
