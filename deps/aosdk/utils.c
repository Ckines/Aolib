...
void hashtable_free(hashtable_t *table)
{
	...
	// PARCHE LOCAL (ver deps/patches/README.md): el array `table->buckets`
	// reservado en hashtable_init() nunca se liberaba aquí, filtrando
	// sizeof(hashtable_bucket_t)*BUCKETS bytes por cada corlett_t
	// decodificado. Detectado con LeakSanitizer.
	free(table->buckets);
	table->buckets = NULL;
}
/// ----------
